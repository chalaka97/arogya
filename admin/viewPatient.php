        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">View Patients List</h2> 
            </div>
          </header>
                        <div class="container">
                        <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="../admin/adminUpatient.php" ><button type="button" class="btn btn-outline-primary"><i class="fas fa-list"></i> Add Patient</button></a>
                            <br><hr><br>
                            <div class="row">
                        ...
                        <table class="table table-hover table-striped " id="dev-table" style="height:200px">
                            ...
                            <tbody class="tb ">
                                <?php
                                $selectQuD = "SELECT * FROM patient ORDER BY patient_id DESC";
