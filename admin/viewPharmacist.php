        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">View Pharmacist List</h2> 
            </div>
          </header>
                        <div class="container">
                        <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="../admin/adminUpharmacist.php" ><button type="button" class="btn btn-outline-primary"><i class="fas fa-list"></i> Add Pharmacist</button></a>
                            <br><hr><br>
                            <div class="row">
                        ...
                        <table class="table table-hover table-striped " id="dev-table" style="height:200px">
                            ...
                            <tbody class="tb ">
                                <?php
                                $selectQuA = "SELECT * FROM pharmacist ORDER BY pharmacist_reg_id DESC";

                                  $runQA=mysqli_query($con,$selectQuA);

                                    if($runQA){
                                            while($data=mysqli_fetch_assoc($runQA)){
                                                $id=$data["pharmacist_reg_id"];
