...
if (isset($_POST['notification'])) {
    //echo "<script>alert('awawawa')</script>"; 
    $name=$_POST['name'];
    $email=$_POST['email'];
    $mobile=$_POST['mobile'];
    ...
    $sqlCon = "INSERT INTO `contact`(`type`, `name`, `phone`, `email`, `message`, `img`) VALUES ('$subject','$name','$mobile','$email','$message','$image')";

        $runContact=mysqli_query($con,$sqlCon);
         if($runContact){
              echo "Complain sent sucess";
              //echo "<script>alert('added')</script>"; 
        } 
        else {
          echo "Error: " . $sqlCon . "<br>" . $con->error;
            //echo "<script>alert('eeeee')</script>"; 
        }
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" method="post">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                        <div class="col-3">
                                          <label for="problem">Choose a fault:</label>
                                          </div>
                                          <div class="col-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="mobile" id="mobile" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = '071xxxxxxx'" placeholder="Enter Mobile Number" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <p class="form-control">  
                                        <input type="file" id="image" name="image" class="btn-primary"></p>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" class="button button-contactForm boxed-btn" name="notification">Send</button>
                            </div>
                        </form>
                    </div>
...
<footer class="footer">
 ...
 &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |Arogya PVT <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
                </div>
            </div>
