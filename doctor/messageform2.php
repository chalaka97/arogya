<?php
    ...
    if(isset($_POST['send_btn'])){
        ...
        //$msg="update appointment set isApproved=1 where patient_id='$p_id'";
            ...
            smsZoomLink($p_name,$p_mobile,$appointment_id,$description,$recode['date'],$recode['time'],$description);
        }
        ...
        <div class="msgframe">
            <table>
                <form method="post">
                    ...
                    <tr>
                        <th>Link</th>
                        <td><input type="text"  id="msg" name ="description" placeholder="Add any description if required...." required>
                        <?php
                            //echo $link;
                        ?>
                        </td>
