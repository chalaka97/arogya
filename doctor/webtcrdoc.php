                ...
                <div class="container">
                        <div class="row">
                            ...
                            <table class="customers table-striped">
                                ...
                                <?php 
                                    $query = "select * from patient p, webtcrdoc w where p.patient_id=w.patient_id";

                                    // $query = "select * from patient p, webtcrdoc w where p.patient_id=w.patient_id and w.doc_id='$_SESSION[doctor_reg_id]' AND is_msg_send='0'";
                                ...
                                <tr>
                                    ...
                                    <td align="center"><a href="messageform.php?p_name=<?php echo $result2['name'];?>&p_mobile=<?php echo $result2['mobile']; ?>"><input type="submit" name="btn" value="Send Link" class="btn"></a></td>
