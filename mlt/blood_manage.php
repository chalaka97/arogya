            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><div class="navbar-brand d-none d-sm-inline-block">
                  <a href="../index.php" class="brand-text d-none d-lg-inline-block"><span>Aarogya Hospital -  </span><strong>MLT -  Blood Bank Management</strong></a>
                 </div>
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <div class="sidebar-header d-flex align-items-center">
            <div class="avatar"><img src="<?php echo $_SESSION['mlt_image'];?>" alt="..." class="img-fluid rounded-circle"></div>
            <div class="title">
              <h2 class="h4"><?php echo $_SESSION['mlt_name'];?></h2>
              <p><?php echo $_SESSION['mlt_id'];?></p>
            </div>
          </div>
