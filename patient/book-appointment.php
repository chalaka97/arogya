<?php
    ...
    {
        $_SESSION['appointment_type'] = $type=$_POST['apptype'];
        $_SESSION['specilization'] = $specilization=$_POST['specilization'];
        $_SESSION['doctor_id'] = $doctorid=$_POST['doctor'];
        $_SESSION['patient_id'] = $patientid=$_SESSION['patient_id'];
        $_SESSION['amount'] = $fees=$_POST['fees'];
        $_SESSION['date'] = $appdate=$_POST['appdate'];
        $_SESSION['time'] = $time=$_POST['apptime'];
