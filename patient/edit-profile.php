...
<?php 
    ...
    {
        $_SESSION['patient_name'] = $name=$_POST['name'];
        $_SESSION['patient_email'] = $email=$_POST['email'];
        $_SESSION['patient_address'] = $address=$_POST['address'];
        $_SESSION['patient_district'] = $district=$_POST['district'];
        $_SESSION['patient_mobile'] = $mobile=$_POST['mobile'];
        $_SESSION['patient_age'] = $age=$_POST['age'];
        $_SESSION['patient_gender'] = $gender=$_POST['gender'];
        $_SESSION['patient_blood_type'] = $blood_type=$_POST['blood_type'];
        $_SESSION['patient_image'] = $img=$_POST['img'];
    ...
    <div class="container p-0">
        ...
        <h4 class="text-center">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <input type="number" name="age" class="form-control" required  value="<?php echo ($row['age']);?>" min="1" max="110">
                </div>
            </div>
            <div class="form-group row">
