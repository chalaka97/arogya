                    ...
                    <div class="col-xl-3 col-lg-2">
                        ...
                        <div class="container">
                            <table class="customers table-striped">
                                ...
                                <?php 
                                    $query="SELECT `d`.`doctor_reg_id`,`d`.`name`,`d`.`specialization`,`d`.`mobile`,`s`.`date`,`s`.`time` FROM `session` as `s`,`doctor` as `d` WHERE `specialization`='physicaltherapy' AND `d`.`doctor_reg_id`=`s`.`doc_id`";
