...
<form role="form" name="book" method="post" >  
    ...
    <div class="form-group">
        ...
        <input type="number" name="qty" class="form-control" min="1" placeholder="Enter quantity" required="true">
    </div>
    <div class="form-group">
        <label><strong>Price<strong></label>
        <input type="number" name="price" class="form-control"  placeholder="Enter price" min="1" required="true">
    </div>  
    <div class="form-group">
