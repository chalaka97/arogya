                ...
                <div class="row no-gutters">
                    ...
                    <form role="form" name="adddoc" method="post" onSubmit="return valid();">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="qty" class="form-control" required="required"  value="<?php echo ($data['quantity']);?>" >
                        </div>
    
                        <div class="form-group">
                            <label><strong>Price</strong></label>
                            <input type="text" name="price" class="form-control" required="required"  value="<?php echo ($data['price']);?>">
                        </div>
