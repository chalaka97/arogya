        ...
        $uploding_folder = "../img/profilePic/";
         $_SESSION['patientPic']=$db_pic_name = $uploding_folder.$picName;
            ...
            if($pass==$conPass){
                ...
                header('location:../reception/VerificationPatient.php');
              ...
              <h2 class="no-margin-bottom">Create Patient</h2>
                        ...
                        <div class="col-md-12">
                            ...
                            <form method ="post" enctype="multipart/form-data" id="form_id">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>Patient ID <sup></sup></strong></label>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>Email Address <sup></sup></strong></label>
                                    <div class="col-sm-7">
                                        <input type="email" class="form-control" name="email" id="email" placeholder="Email Address" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>Full Name <sup></sup></strong></label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="fullName" id="fullName" placeholder="Full Name" required>
                                    </div>
                                </div>
                               <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>Address <sup></sup></strong></label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="address" id="address" placeholder="Address" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>District <sup></i></sup></strong></label>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>Mobile No <sup></sup></strong></label>
                                    <div class="col-sm-3">
                                        <input type="tel" class="form-control" name="mobile" id="mobile" placeholder="Mobile No 07********" pattern="0[0-9]{9}" required>
                                    </div>
                             
                                    <label class="col-sm-2 col-form-label"><strong>Age <sup></sup></strong></label>
                                    <div class="col-sm-2">
                                        <input type="tel" class="form-control" name="age" id="age" placeholder="age" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>Gender <sup></sup></strong></label>
                                    <div class="col-sm-3">
                                    ...
                                    <label class="col-sm-2 col-form-label"><strong>Blood Type <sup></sup></strong></label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>Password <sup></sup></strong></label>
                                    <div class="col-sm-7">
                                        <input type="password" class="form-control" name="pass" id="pass" placeholder="Password" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>Re-enter Password <sup></i></sup></strong></label>
                                    <div class="col-sm-7">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>Upload Your Image <sup></i></sup></strong></label>
                                     <div class="col-sm-7">
