...
if(isset($_POST['btn'])){
    require('fpdf/fpdf.php');
        ...
        class PDF extends FPDF
        {
            ...
            {
                // Logo
                $this->Image('../img/logo2.png',10,12,30,0,'','');
                $this->Ln(30);
        ...
        $pdf = new PDF();
        // Column headings
        $header = array('Date','Doctor Name', 'specialization', 'Description','Amount ');
...
<form method="post">
    ...
    <?php
       ...
       fwrite($fp,$row2['date'].';'.$row1['name'].';'.$row1['specialization'].';'.$row3['description'].';'.$row3['amount']);
       fwrite($fp,"\n");
